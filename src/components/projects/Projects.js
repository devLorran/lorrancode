    ...
    <section className="realeased-projects">
        ...
        <div className="projects-grid reveal">
            <div className="project-card">
                ...
                <a href="https://github.com/devLorran/clone-netflix">Ver Projeto</a>
            </div>
            <div className="project-card">
                ...
                <a href="https://devlorran.github.io/movie-website/">Ver Projeto</a>
            </div>
            <div className="project-card">
                <span>Dashboard</span>
                <p> Dashboard responsivo feito com HTML5, CSS3, JavaScript e Vanilla para utilização de gráficos  </p>
                <a href="https://devlorran.github.io/dashboard/">Ver Projeto</a>
            </div>
        </div>
